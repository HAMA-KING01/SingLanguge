...
ACTIONS = [
    "shave", "catch", "drown", "cool", "envelope", "cry", "pineapple", "pop", "banana", "sandwich",
    "strawberry", "cloud", "dog", "bury", "cross", "chew", "pipe", "castle", "yawn", "scarf",
    "corn", "slice", "bow", "arm", "stack", "stethoscope", "basketball", "right", "spread", "cat",
    "carrot", "bark", "story", "stamp", "conduct", "peel", "arrest", "dark", "elevator", "pillow",
    "dip", "sweater", "baby", "bat", "dolphin", "screwdriver", "shoulder", "toy", "support", "wristwatch"
